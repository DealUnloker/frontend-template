...
import { zAddPetResponse, zCreateUserResponse, zCreateUsersWithListInputResponse, zFindPetsByStatusResponse, zFindPetsByTagsResponse, zGetInventoryResponse, zGetOrderByIdResponse, zGetPetByIdResponse, zGetUserByNameResponse, zLoginUserResponse, zPlaceOrderResponse, zUpdatePetResponse, zUpdatePetWithFormResponse, zUploadFileResponse } from './zod.gen';
 ...
 * Add a new pet to the store.
 */
export const addPet = <ThrowOnError extends boolean = false>(options: Options<AddPetData, ThrowOnError>): RequestResult<AddPetResponses, AddPetErrors, ThrowOnError> => (options.client ?? client).post<AddPetResponses, AddPetErrors, ThrowOnError>({
 ...
 */
export const updatePet = <ThrowOnError extends boolean = false>(options: Options<UpdatePetData, ThrowOnError>): RequestResult<UpdatePetResponses, UpdatePetErrors, ThrowOnError> => (options.client ?? client).put<UpdatePetResponses, UpdatePetErrors, ThrowOnError>({
 ...
 */
export const findPetsByStatus = <ThrowOnError extends boolean = false>(options: Options<FindPetsByStatusData, ThrowOnError>): RequestResult<FindPetsByStatusResponses, FindPetsByStatusErrors, ThrowOnError> => (options.client ?? client).get<FindPetsByStatusResponses, FindPetsByStatusErrors, ThrowOnError>({
 ...
 */
export const findPetsByTags = <ThrowOnError extends boolean = false>(options: Options<FindPetsByTagsData, ThrowOnError>): RequestResult<FindPetsByTagsResponses, FindPetsByTagsErrors, ThrowOnError> => (options.client ?? client).get<FindPetsByTagsResponses, FindPetsByTagsErrors, ThrowOnError>({
 ...
 */
export const updatePetWithForm = <ThrowOnError extends boolean = false>(options: Options<UpdatePetWithFormData, ThrowOnError>): RequestResult<UpdatePetWithFormResponses, UpdatePetWithFormErrors, ThrowOnError> => (options.client ?? client).post<UpdatePetWithFormResponses, UpdatePetWithFormErrors, ThrowOnError>({
 ...
 */
export const deleteOrder = <ThrowOnError extends boolean = false>(options: Options<DeleteOrderData, ThrowOnError>): RequestResult<DeleteOrderResponses, DeleteOrderErrors, ThrowOnError> => (options.client ?? client).delete<DeleteOrderResponses, DeleteOrderErrors, ThrowOnError>({ url: '/store/order/{orderId}', ...options });
 ...
 */
export const getOrderById = <ThrowOnError extends boolean = false>(options: Options<GetOrderByIdData, ThrowOnError>): RequestResult<GetOrderByIdResponses, GetOrderByIdErrors, ThrowOnError> => (options.client ?? client).get<GetOrderByIdResponses, GetOrderByIdErrors, ThrowOnError>({
 ...
 * Creates list of users with given input array.
 */
export const createUsersWithListInput = <ThrowOnError extends boolean = false>(options?: Options<CreateUsersWithListInputData, ThrowOnError>): RequestResult<CreateUsersWithListInputResponses, CreateUsersWithListInputErrors, ThrowOnError> => (options?.client ?? client).post<CreateUsersWithListInputResponses, CreateUsersWithListInputErrors, ThrowOnError>({
 ...
 * Log into the system.
 */
export const loginUser = <ThrowOnError extends boolean = false>(options?: Options<LoginUserData, ThrowOnError>): RequestResult<LoginUserResponses, LoginUserErrors, ThrowOnError> => (options?.client ?? client).get<LoginUserResponses, LoginUserErrors, ThrowOnError>({
 ...
 */
export const logoutUser = <ThrowOnError extends boolean = false>(options?: Options<LogoutUserData, ThrowOnError>): RequestResult<LogoutUserResponses, LogoutUserErrors, ThrowOnError> => (options?.client ?? client).get<LogoutUserResponses, LogoutUserErrors, ThrowOnError>({ url: '/user/logout', ...options });
 ...
 * This can only be done by the logged in user.
 */
export const deleteUser = <ThrowOnError extends boolean = false>(options: Options<DeleteUserData, ThrowOnError>): RequestResult<DeleteUserResponses, DeleteUserErrors, ThrowOnError> => (options.client ?? client).delete<DeleteUserResponses, DeleteUserErrors, ThrowOnError>({ url: '/user/{username}', ...options });
 ...
 */
export const getUserByName = <ThrowOnError extends boolean = false>(options: Options<GetUserByNameData, ThrowOnError>): RequestResult<GetUserByNameResponses, GetUserByNameErrors, ThrowOnError> => (options.client ?? client).get<GetUserByNameResponses, GetUserByNameErrors, ThrowOnError>({
